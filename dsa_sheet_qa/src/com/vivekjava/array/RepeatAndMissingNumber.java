...
public class RepeatAndMissingNumber {
    ...
    public static ArrayList<Integer> repetedNumber(List<Integer> A) {
        ArrayList<Integer> num = new ArrayList<>();

        HashSet<Integer> checkset = new HashSet<>();
        for (int i = 0; i < A.size(); i++) {
            if (checkset.contains(A.get(i))) {
                num.add(A.get(i));
            } else {
    ...
    //check by negative number
    //https://www.youtube.com/watch?v=qfbBRtbhQ04
    public static ArrayList<Integer> repetedNumberApproach2(List<Integer> A) {
        ArrayList<Integer> num = new ArrayList<>();
...
//        A.add(2);
        ...
        ArrayList<Integer> ans = repetedNumber(A);
        for (int i = 0; i < ans.size(); i++) {
            System.out.print(ans.get(i) + " ");
        }

        System.out.println("Approach2");
        ArrayList<Integer> ans2 = repetedNumberApproach2(A);
        for (int i = 0; i < ans.size(); i++) {
            System.out.print(ans.get(i) + " ");
        }
